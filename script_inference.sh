...
model_path="pretrained/celebahq_p2.pt"
...
CUDA_VISIBLE_DEVICES=$gpu python main.py --run_test                         \
                        ...
                        --dt_lambda $dt_lambda                              \
                        --custom_train_dataset_dir "custom_datasets/celeba_hq_256/train"                \
                        --custom_test_dataset_dir "custom_datasets/celeba_hq_256/test"                  \
